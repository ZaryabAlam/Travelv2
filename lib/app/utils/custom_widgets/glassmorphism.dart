...
// ignore_for_file: overridden_fields, unused_local_variable, unnecessary_this, prefer_initializing_formals, prefer_typing_uninitialized_variables
...
class GlassmorphicContainer extends StatelessWidget {
  ...
  GlassmorphicContainer({
    ...
    required this.borderGradient,
        ...
        assert(padding == null || padding.isNonNegative),
        assert(constraints == null || constraints.debugAssertIsValid()),
        constraints = constraints?.tighten(width: width, height: height) ?? BoxConstraints.tightFor(width: width, height: height),
        super(key: key);
