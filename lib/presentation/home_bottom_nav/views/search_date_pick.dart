      ...
      body: Column(
        children: [
              ...
              child: Column(
                children: [
                  TabBar(
                      ...
                      labelPadding: EdgeInsets.symmetric(horizontal: 8.0, vertical: 10.0),
                      tabs: [CommonText(text: 'Departing'), CommonText(text: 'Reporting')]),
          ...
          Padding(
            ...
            child: CustomButton(height: 40, width: w, text: 'Confirm Date', onPress: () {}),
          ),
        ],
      ),
    );
