...
import '../controller/payment_waafipay_controller.dart';

class PaymentWaafiScreen extends StatefulWidget {
  String searchID;
  String flightID;
  String paymentID;
  //
...
//
  ...
  @override
  State<PaymentWaafiScreen> createState() => _PaymentWaafiScreenState();
}

class _PaymentWaafiScreenState extends State<PaymentWaafiScreen> {
  TextEditingController fullNameController = TextEditingController();
  TextEditingController numberController = TextEditingController();
  final WaafiBookingController waafiBookingController =
      Get.put(WaafiBookingController());
  String phoneNumber = '';
  String phoneCode = '+1';
